...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AttributController' => 'getAttributControllerService',
            'App\\Controller\\AuthController' => 'getAuthControllerService',
            'App\\Controller\\BiographyController' => 'getBiographyControllerService',
            ...
            'App\\Controller\\DeclinaisonController' => 'getDeclinaisonControllerService',
            ...
            'App\\Entity\\Fournisseur' => 'getFournisseurService',
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $h = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($d, $e, $f, ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), ($this->privates['api_platform.operation_path_resolver.router'] ?? $this->getApiPlatform_OperationPathResolver_RouterService()), NULL, $g, NULL, false, 'oauth2', 'application', '', '', [], [], ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions'], ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), NULL, true, new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~9zwUgXL'] ?? $this->get_1Serializer9zwUgXLService()))));
        $i = ($this->privates['api_platform.router'] ?? $this->getApiPlatform_RouterService());
        ...
        $l = ($this->privates['api_platform.iri_converter.legacy'] ?? $this->load('getApiPlatform_IriConverter_LegacyService'));
        ...
        $o = ($this->privates['property_info'] ?? $this->getPropertyInfoService());
        $p = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n);
        $q = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $j, $b, $o, $p, NULL, ['enable_max_depth' => true, 'yaml_indentation' => 2]);

        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), 1 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 2 => $c, 3 => $h, 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($i, [], $j), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $j, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 6 => $h, 7 => $c, 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($d, $e, $f, $k, NULL, $i, NULL, $j), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($d, $l, $i), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($i, true, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 11 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(['enable_max_depth' => true, 'yaml_indentation' => 2]), 14 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($d, $e, $f, $l, $k, $m, $b, $j, $n, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $a), 15 => new \ApiPlatform\Serializer\ItemNormalizer($e, $f, $l, $k, $b, $j, $n, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $d, $a, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(['enable_max_depth' => true, 'yaml_indentation' => 2]), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer(['enable_max_depth' => true, 'yaml_indentation' => 2], $j), 18 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $j, $o, $p, NULL)), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(['enable_max_depth' => true, 'yaml_indentation' => 2]), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 23 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 24 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $k, $l, NULL, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 'page', 'pagination', $d, $b), $d, $k, $g), 25 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 26 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($q, $l, $m), 27 => $q], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(['enable_max_depth' => true, 'yaml_indentation' => 2]), 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, ['enable_max_depth' => true, 'yaml_indentation' => 2]))), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, ['enable_max_depth' => true, 'yaml_indentation' => 2]), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(['enable_max_depth' => true, 'yaml_indentation' => 2]), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AttributRepository' => ['privates', 'App\\Repository\\AttributRepository', 'getAttributRepositoryService', true],
            'App\\Repository\\BiographyRepository' => ['privates', 'App\\Repository\\BiographyRepository', 'getBiographyRepositoryService', true],
            ...
            'App\\Repository\\DeclinaisonRepository' => ['privates', 'App\\Repository\\DeclinaisonRepository', 'getDeclinaisonRepositoryService', true],
            ...
            'App\\Repository\\ProductGalleryRepository' => ['privates', 'App\\Repository\\ProductGalleryRepository', 'getProductGalleryRepositoryService', true],
            'App\\Repository\\ProductRepository' => ['privates', 'App\\Repository\\ProductRepository', 'getProductRepositoryService', true],
            'App\\Repository\\SimpleProductRepository' => ['privates', 'App\\Repository\\SimpleProductRepository', 'getSimpleProductRepositoryService', true],
            ...
            'App\\Repository\\DeclinaisonRepository' => '?',
    ...
    /**
     * Gets the private '.1_Serializer~9zwUgXL' shared service.
     *
     * @return \Symfony\Component\Serializer\Serializer
     */
    protected function get_1Serializer9zwUgXLService()
    {
        return $this->privates['.1_Serializer~9zwUgXL'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['property_info'] ?? $this->getPropertyInfoService()))], [0 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, ['enable_max_depth' => true, 'yaml_indentation' => 2])))]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('33gjUkaTGw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-oxyZnF46f', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DPr1njO6vm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pr3zwuqjNI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4RY7eI6uw0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.openapi.normalizer.api_gateway'] = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~9zwUgXL'] ?? $this->get_1Serializer9zwUgXLService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IuXwOarsc9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oi-ob93DOo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
